...
var email_default_title = "",
	url_title_mail_body = email_default_title + escape(" ") + urls.test_e,
	no_url_no_title_mail_body = defaults.title+ escape(" ") + urls.localhost_e,
	url_no_title_mail_body = defaults.title + escape(" ") + urls.test_e,
	no_url_title_mail_body = email_default_title + escape(" ") + urls.localhost_e,
...
_test({
	...
	expected_url: urls.email + url_params.mail_body + no_url_no_title_mail_body + url_params.subject + defaults.title
});

_test({
	name: "em - container + no url + title",
	class_tag: class_tags.email + tags.container + tags.title,
	expected_url: urls.email + url_params.mail_body + no_url_title_mail_body + url_params.subject + email_default_title
});

_test({
	name: "em - container + url + title + subject",
	class_tag: class_tags.email + tags.container + tags.url_title + tags.subject,
	expected_url: urls.email + url_params.mail_body + url_title_mail_body+ url_params.subject + defaults.subject
});

_test({
	name: "em - container + url + no title + subject",
	class_tag: class_tags.email + tags.container + tags.url + tags.subject,
	expected_url: urls.email + url_params.mail_body + url_no_title_mail_body + url_params.subject + defaults.subject
});
...
_test({
	...
	expected_url: urls.email + defaults.address + url_params.mail_body + url_title_mail_body + url_params.subject + email_default_title
});
...
_test({
	...
	expected_url: urls.email + defaults.multi_address + url_params.mail_body + url_title_mail_body + url_params.container + url_params.subject + email_default_title
});
*/
;
